...
const Chambelanes = () => {
  return (
    <PageLayout 
      title="Chambelanes" 
      subtitle="Acompañantes de honor en mi celebración"
    >
      <div className="max-w-4xl mx-auto bg-white/90 backdrop-blur-sm rounded-xl shadow-xl overflow-hidden mb-10 border border-primary/20 content-card">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
        ...
        {[
          ...
          <div key={index} className="bg-white/90 backdrop-blur-sm rounded-xl shadow-xl overflow-hidden border border-primary/10 transition-transform duration-300 hover:scale-105 content-card">
      ...
      <div className="mt-12 max-w-4xl mx-auto bg-white/90 backdrop-blur-sm rounded-xl shadow-xl p-8 border border-primary/20 content-card">
