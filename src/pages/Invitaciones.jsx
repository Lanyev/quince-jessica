      ...
      <div className="container-responsive desktop-section tablet-section mobile-section">
        <div className="content-max-width">
          ...
          <div className="text-center mb-16">
            <h1 className="font-script text-6xl md:text-7xl lg:text-8xl xl:text-9xl ultra-wide-title mobile-title font-bold text-primary mb-3 animate-fade-in">
              Invitaciones
            </h1>
            <p className="font-serif text-2xl md:text-3xl lg:text-4xl text-primary-light italic animate-fade-in delay-200">
              Comparte la emoción
            </p>
          ...
          <div id="invitation-creator" className="mb-16">
            <InvitationCard />
          </div>
